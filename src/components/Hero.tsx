  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-lg md:text-2xl text-white/80 font-light tracking-[0.15em] uppercase mb-10">
          Korean Grill &amp; Bar
        </p>
        ...
        <div className="mb-8">
          <Link
            href="/menu"
            className="btn-primary text-base md:text-lg px-12 py-4 md:px-14 md:py-5"
          >
            View Our Menu
          </Link>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch justify-center gap-3 max-w-lg mx-auto">
          ...
          >
            ...
            <p className="text-xs text-white/40 mb-3">Fair Oaks Mall</p>
            <p className="text-base md:text-lg text-white/80 font-semibold mb-3">
              (240) 956-7540
            </p>
            <span
              onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.open('https://www.yelp.com/biz/khan-korean-grill-and-bar-fairfax', '_blank'); }}
          ...
          >
            ...
            <p className="text-xs text-white/40 mb-3">Merchant Plaza</p>
            <p className="text-base md:text-lg text-white/80 font-semibold mb-3">
              (202) 809-2104
            </p>
            <span
              onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.open('https://www.yelp.com/biz/khan-korean-grill-and-bar-woodbridge', '_blank'); }}
              className="inline-flex items-center gap-1.5 text-xs text-amber-400/70 hover:text-amber-400 transition-colors font-medium"
            >
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
